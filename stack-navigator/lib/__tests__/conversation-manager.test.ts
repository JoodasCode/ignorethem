...
jest.mock('../types/conversation', () => ({
  // Export empty objects for types since they're just interfaces
}))
...
describe('ConversationManager', () => {
  ...
  describe('Context Extraction', () => {
    ...
    it('should handle multiple project types and use the last one', () => {
      const messages: ChatMessage[] = [
        {
          id: '1',
          role: 'user',
          content: 'I want to build an e-commerce store',
          timestamp: new Date()
        },
        {
          id: '2',
          role: 'user',
          content: 'Actually, I changed my mind to a SaaS application',
          timestamp: new Date()
        }
      ]
    ...
    it('should accumulate requirements from multiple messages', () => {
      const messages: ChatMessage[] = [
        ...
        },
        {
          id: '2',
          role: 'user',
          content: 'Also need payment processing',
          timestamp: new Date()
        },
        {
          id: '3',
          role: 'user',
          content: 'And analytics tracking would be great',
          timestamp: new Date()
        }
      ]
      ...
      expect(context.specificRequirements).toContain('authentication')
      expect(context.specificRequirements).toContain('payments')
      expect(context.specificRequirements).toContain('analytics')
      expect(context.specificRequirements).toHaveLength(3)
    })
  })
  ...
  describe('Project Analysis', () => {
    ...
    it('should determine scaling needs based on context', () => {
      const messages: ChatMessage[] = [
        {
          id: '1',
          role: 'user',
          content: 'Building a SaaS application',
          timestamp: new Date()
        },
        {
          id: '2',
          role: 'user',
          content: 'I am worried about scaling to millions of users',
          timestamp: new Date()
        }
      ]
      ...
      expect(analysis.scalingNeeds).toBe('high')
    })
    ...
    it('should not duplicate requirements', () => {
      const messages: ChatMessage[] = [
        ...
        },
        {
          id: '2',
          role: 'user',
          content: 'I also need user authentication',
          timestamp: new Date()
        }
      ]
      ...
      expect(context.specificRequirements).toEqual(['authentication'])
    })
  })
})